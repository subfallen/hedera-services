...
public record LedgerConfig(
        ...
        @ConfigProperty(defaultValue = "5000000000000000000") @Min(0)
        long totalTinyBarFloat,
        ...
        @ConfigProperty(defaultValue = "98") @NetworkProperty
        long fundingAccount,

        @ConfigProperty(value = "transfers.maxLen", defaultValue = "10") @NetworkProperty
        int transfersMaxLen,

        @ConfigProperty(value = "tokenRejects.maxLen", defaultValue = "10") @NetworkProperty
        int tokenRejectsMaxLen,

        @ConfigProperty(value = "tokenTransfers.maxLen", defaultValue = "10") @NetworkProperty
        int tokenTransfersMaxLen,

        @ConfigProperty(value = "nftTransfers.maxLen", defaultValue = "10") @NetworkProperty
        int nftTransfersMaxLen,
        ...
        @ConfigProperty(defaultValue = "750") @NetworkProperty
        long numReservedSystemEntities) {}
